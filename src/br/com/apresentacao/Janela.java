...
public class Janela extends javax.swing.JFrame {
	private ComprarPassagemControlador comprarPassagemControlador;
	...
	public Janela() {
		comprarPassagemControlador = new ComprarPassagemControlador();
																...
																jPanel1Layout.createSequentialGroup()
																		.addGroup(
																				jPanel1Layout
																						...
																						.addComponent(
																								jComboBox5, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	// adiciona lista de tipo datas
	private void jComboBox5PopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
		List<String> listaDestino = comprarPassagemControlador.getData(jComboBox1.getSelectedItem().toString());
		// lista de aeroportos de destino
		for (String item : listaDestino) {
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) throws ParseException {
		...
		String documento = jComboBox2.getSelectedItem().toString();
		String tipoPassagem = jComboBox4.getSelectedItem().toString();
		String aeroportoOrigem = jComboBox1.getSelectedItem().toString();
		String aeroportoDestino = jComboBox3.getSelectedItem().toString();
		String data = jComboBox5.getSelectedItem().toString();
		
		//compra de uma passagem
		comprarPassagemControlador.comprar(nome, documento, tipoPassagem, aeroportoOrigem, aeroportoDestino, data);
	}
