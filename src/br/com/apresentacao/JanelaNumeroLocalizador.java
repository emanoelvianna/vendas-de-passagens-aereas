...
public class JanelaNumeroLocalizador extends javax.swing.JFrame {

	/**
	 * Creates new form JanelaNumeroLocalizador
	 */
	public JanelaNumeroLocalizador() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		jLabel1.setText("Seu número localizador:");
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup().addGap(131, 131, 131).addComponent(jLabel1))
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(JanelaNumeroLocalizador.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new JanelaNumeroLocalizador().setVisible(true);
			}
		});
	}
	...
	public void setLocalizador(int localizador) {
		jTextField1.setText(String.valueOf(localizador));
	}
}
